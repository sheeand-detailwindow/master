<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EmailConfirm.aspx.cs" Inherits="detailwindow.EmailConfirm" %>
...
<%@ Register TagPrefix="uc1" TagName="contentEmailConfirm" Src="~/uc/contentEmailConfirm.ascx" %>
...
<body>
    ...
    <form id="Form2" runat="server">
		...
		<uc1:contentEmailConfirm id="ContentApptConfirm1" runat="server"></uc1:contentEmailConfirm>
