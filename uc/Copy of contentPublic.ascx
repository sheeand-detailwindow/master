<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="contentPublic.ascx.cs" Inherits="detailwindow.contentPublic" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>
<div id="contentBox">
<span id="heading2">DETAIL WINDOW CLEANING</span>
<p><span id="Span1" class="paragraphHeading">We have received the <strong>"Angie's List Super Service 
