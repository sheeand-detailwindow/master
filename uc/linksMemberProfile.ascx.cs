...
{
    public partial class linksMemberProfile : System.Web.UI.UserControl
    {
        protected void Page_Load(object sender, System.EventArgs e)
        {
            ...
            // This is now handled in stringProfile()
        ...
        protected int testProfileContents()
        {
            ...
            catch (Exception ex)
            {
                ...
                Session["ErrorCode"] = "Customer ID: " + Session["ID"] +
                    " <br /> Page: linksMemberProfile <br /> Line: 222 <br /> Message: " + ex.Message.ToString();
            }
            finally
            {
                if (objReader != null)
        ...
        // This subroutine returns the profile text for the inquiry

        protected string stringProfile()
        {
            string strText = "";
            ...
            try
            {
                ...
                if (objReader.Read())
                {
                    ...
                    strText = strName + " " + strLastName + "<br />";
                    if (strCompany.Length > 4)
                    {
                        strText = strText + strCompany + "<br />";
                    }
                    if (strSubdivision.Length > 4)
                    {
                        strText = strText + strSubdivision + " <em>subdivision</em><br />";
                    }
                    strText = strText + strAddress + "<br />" + strCity + " &nbsp;" + strZip + "<br /><br /><em>Home phone:</em> " + strPhone1 + "<br /><em>Cell phone: </em>" + strPhone2 + "<br /><em>Work phone: </em>" + strPhone3 + "<br /><br /><em>Email address: </em>" + strEmail + "<br />";
                }
                else
                {
                    lblErrorMessage.Text = "Could not retrieve user record.";
            ...
            catch (Exception ex)
            {
                lblErrorMessage.Text = ex.Message.ToString();
                Session["ErrorCode"] = "Customer ID: " + Session["ID"] +
                    " <br /> Page: linksMemberProfile <br /> Line: 302 <br /> Message: " + ex.Message.ToString();
            }
            finally
            {
                if (objReader != null)
